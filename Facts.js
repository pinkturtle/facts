...
(function() {
  var Datom, Events, Facts, Immutable, List, Map, Set, Stack, dispatch, elapsedSinceProgramStart, eventSplitter, eventsApi, identifiesTransaction, internalOn, isTransaction, isUnrecognizedOperation, key, mapEachDatom, match, offApi, onApi, onceMap, programStartTime, recognizedOperations, ref, takeSampleOf, toIdentifiedEntities, toTruth, triggerApi, triggerEvents, validate, value,
